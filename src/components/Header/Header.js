...
const Header = () => {
  ...
  const navLinkCertificate = useRef();
            ...
            <ul>
              ...
              <div className="header__social">
                <p className="header__linkedin">
                  <a href="https://www.linkedin.com/in/ajay-kumar-sinha-a5097624b/" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faLinkedin} size="2x" /></a>
                </p>

                <p className='header__github'>
                  <a href="https://github.com/aksinha214" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faGithub} size="2x" /></a>
                </p>
                <p className='header__github'>
                  <a href="https://www.instagram.com/azaysinha?igsh=MXFvam56aDZ4cGhiOQ==" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faInstagram} size="2x" /></a>
                </p>

                <p className='header__youtube'>
                  <a href="https://x.com/ajaysinha2222?t=bdPBqVxLsATZeQT-qE3hXg&s=09" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faTwitter} size="2x" /></a>
                </p>
              </div>
            </ul>
          </div>
